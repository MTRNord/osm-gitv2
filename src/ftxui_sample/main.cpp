...
// configuration step. It creates a namespace called `osm_gitv2`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", osm_gitv2::cmake::project_name, osm_gitv2::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", osm_gitv2::cmake::project_version);
      return EXIT_SUCCESS;
    }
